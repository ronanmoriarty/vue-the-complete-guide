export default {
    async registerCoach(context, data) {
        ...
        const idToken = context.rootGetters.token;
        const coachData = {
        ...
        const response = await fetch(`https://vue-coach-finder-4c88d-default-rtdb.europe-west1.firebasedatabase.app/coaches/${userId}.json?auth=${idToken}`, {
            method: 'PUT',

...
<script>
    export default {
        ...
        methods: {
            submit() {
                this.$http.post('https://vuejs-http-180c1-default-rtdb.europe-west1.firebasedatabase.app/data.json', this.user)
                    .then(response => {
            ...
            fetchData() {
                this.$http.get('https://vuejs-http-180c1-default-rtdb.europe-west1.firebasedatabase.app/data.json')
                    .then(response => {
